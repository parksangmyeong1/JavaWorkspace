	...
	<main role="main" class="container">
		...
		<form method="post" enctype="multipart/form-data">
			<table>
				...
				<tr>
					<td>사진</td>
					<td><input type="file" name="photo" class="m-2"></td>
				</tr>
				<tr>
					<td></td>
					<td><input type="submit" value="회원가입" class="form-control m-2 btn btn-primary"> <input type="reset" class="form-control m-2 btn btn-info">
					</td>
				</tr>
			</table>
		</form>
